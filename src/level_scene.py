...
class LevelScene(Scene):
    def __init__(self, *args, **kwargs):
        ...
        self.ships = []
        # self.spawn_ship("r90 t33 d200; t0 d500; r0 t33 d2000; r360 d260; r0 t33 d800; t0 d2500; t21 d1500; t0", "PlasmaStarfish")
        self.spawn_ship("t100 r00", "superduperpacman42")
